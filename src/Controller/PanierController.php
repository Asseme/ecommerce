...
class PanierController extends AbstractController
{
    ...
    public function new(Request $request,TranslatorInterface $translator): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $entityManager->flush();
            $this->addFlash('success',$translator->trans('panier.ajoute'));
     ...
     */
    public function edit(Request $request, Panier $panier,TranslatorInterface $translator): Response
    {
        $form = $this->createForm(PanierType::class, $panier);
        $form->handleRequest($request);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash('success',$translator->trans('panier.modifie'));
            return $this->redirectToRoute('panier_index');
        }
    ...
    public function delete(Request $request, Panier $panier,TranslatorInterface $translator): Response
    {
        if ($this->isCsrfTokenValid('delete'.$panier->getId(), $request->request->get('_token'))) {
            ...
            $entityManager->flush();
            $this->addFlash('danger',$translator->trans('panier.supp'));
        }
